...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divUserInfo" class="col-lg-5" align="center">
        ...
        <asp:Label ID="lblName" runat="server" Text="此欄位不可空白" Visible="false"></asp:Label><br />
        ...
        <asp:Label ID="lblEmail1" runat="server" Text="此欄位不可空白" Visible="false"></asp:Label>
        <asp:Label ID="lblEmail2" runat="server" Text="無效的郵件地址" Visible="false"></asp:Label><br />
        ...
        <asp:Label ID="lblAge" runat="server" Text="此欄位不可空白" Visible="false"></asp:Label>
    </div>
